    ...
    <div>
      ...
      <div className="relative mb-6 max-w-md">
        ...
        <input
          ...
          className="w-full pl-8 pr-3 py-1.5 text-sm rounded-md border border-border/50 bg-background text-foreground placeholder:text-muted-foreground/90 outline-none"
        />
      </div>
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        <button
                          ...
                          className={`min-w-[100px] h-7 flex items-center justify-center rounded-md border text-sm px-2 transition-colors ${
                            isRecording
