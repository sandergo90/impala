...
export function PlanAnnotationForm({ lineNumber, onSubmit, onCancel }: PlanAnnotationFormProps) {
  ...
  return (
    <form
      ...
      className="mx-4 my-2 p-3 rounded-lg border border-border bg-card"
    ...
    >
      <div className="flex gap-3">
        ...
        <div className="flex-1 min-w-0">
          <div className="text-sm text-muted-foreground mb-1.5 font-mono">
            Line {lineNumber}
          </div>
          <textarea
            ref={textareaRef}
