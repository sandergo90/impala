        ...
        >
          <div className="flex items-center border-b border-border px-3">
            ...
            <Command.Input
              ...
              className="flex h-10 w-full bg-transparent py-3 text-[12px] text-foreground placeholder:text-muted-foreground/50 outline-none"
            />
          </div>
          <Command.List className="max-h-[300px] overflow-y-auto p-1.5">
            ...
            {selectedProject && worktrees.length > 0 && (
              <Command.Group heading="Worktrees" className="[&_[cmdk-group-heading]]:px-2 [&_[cmdk-group-heading]]:py-1.5 [&_[cmdk-group-heading]]:text-[9px] [&_[cmdk-group-heading]]:uppercase [&_[cmdk-group-heading]]:tracking-[1.2px] [&_[cmdk-group-heading]]:text-muted-foreground/60 [&_[cmdk-group-heading]]:font-semibold">
                {worktrees.map((wt) => {
                  ...
                  return (
                    <Command.Item
                      ...
                      className="flex items-center gap-2 px-2 py-1.5 rounded-md text-[11px] cursor-pointer data-[selected=true]:bg-accent"
                    >
            ...
            {/* Projects */}
            {projects.length > 1 && (
              <Command.Group heading="Projects" className="[&_[cmdk-group-heading]]:px-2 [&_[cmdk-group-heading]]:py-1.5 [&_[cmdk-group-heading]]:text-[9px] [&_[cmdk-group-heading]]:uppercase [&_[cmdk-group-heading]]:tracking-[1.2px] [&_[cmdk-group-heading]]:text-muted-foreground/60 [&_[cmdk-group-heading]]:font-semibold">
            ...
            {/* Actions */}
            <Command.Group heading="Actions" className="[&_[cmdk-group-heading]]:px-2 [&_[cmdk-group-heading]]:py-1.5 [&_[cmdk-group-heading]]:text-[9px] [&_[cmdk-group-heading]]:uppercase [&_[cmdk-group-heading]]:tracking-[1.2px] [&_[cmdk-group-heading]]:text-muted-foreground/60 [&_[cmdk-group-heading]]:font-semibold">
              {selectedWorktree && (
                <>
                  <Command.Item
                    value="Switch to Diff view"
                    onSelect={() => handleAction("diff-tab")}
                    className="flex items-center gap-2 px-2 py-1.5 rounded-md text-[11px] text-muted-foreground cursor-pointer data-[selected=true]:bg-accent"
                  >
              ...
              >
                ...
                Settings
                <span className="ml-auto text-[9px] text-muted-foreground/50 font-mono">&#8984;,</span>
              </Command.Item>
            </Command.Group>
          </Command.List>
        </Command>
