      ...
      <div className="flex gap-3">
        ...
        <div className="flex-1 min-w-0">
          <textarea
            ...
            rows={3}
            className="w-full px-3 py-2 text-sm rounded-md border border-border bg-background text-foreground resize-y outline-none placeholder:text-muted-foreground/90"
            onKeyDown={(e) => {
              if (e.key === "Escape") {
                e.preventDefault();
                onCancel();
