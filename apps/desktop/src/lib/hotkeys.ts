...
export const HOTKEYS = {
  ...
  SWITCH_TAB_TERMINAL: { label: "Switch to Terminal", default: "meta+shift+1", category: "Navigation" },
  SWITCH_TAB_DIFF: { label: "Switch to Diff", default: "meta+shift+2", category: "Navigation" },
  SWITCH_TAB_SPLIT: { label: "Switch to Split", default: "meta+shift+3", category: "Navigation" },
  SWITCH_TAB_PLAN: { label: "Switch to Plan", default: "meta+shift+4", category: "Navigation" },
