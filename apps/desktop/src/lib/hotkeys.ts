...
export const HOTKEYS = {
  ...
  SWITCH_TAB_TERMINAL: { label: "Switch to Terminal", default: "ctrl+1", category: "Navigation" },
  SWITCH_TAB_DIFF: { label: "Switch to Diff", default: "ctrl+2", category: "Navigation" },
  SWITCH_TAB_SPLIT: { label: "Switch to Split", default: "ctrl+3", category: "Navigation" },
  SWITCH_TAB_PLAN: { label: "Switch to Plan", default: "ctrl+4", category: "Navigation" },
