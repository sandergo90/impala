...
const RUNTIME_TAG: &str = "pty-daemon";
...
pub fn init() -> Guard {
    let session_id = std::env::var("IMPALA_SESSION_ID")
    ...
    let env_filter = EnvFilter::try_from_default_env()
        .or_else(|_| EnvFilter::try_new("info,impala_pty_daemon=debug"))
        .unwrap();
    ...
    tracing::info!(
        ...
        "pty-daemon observability initialised"
    );
